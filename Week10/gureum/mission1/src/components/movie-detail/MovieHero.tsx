...
interface MovieHeroProps {
  ...
  director?: string;
  onClose?: () => void;
  showImdbSearch?: boolean;
}

const MovieHero = ({ movie, director, onClose, showImdbSearch = false }: MovieHeroProps) => {
          ...
          <div className="flex-1 text-white">
            ...
            {showImdbSearch && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="mb-6 inline-flex rounded-lg bg-yellow-400 px-5 py-3 font-bold text-gray-950 transition hover:bg-yellow-300"
              >
                IMDb에서 검색하기
              </a>
            )}
