...
// 로컬스토리지에서 안전하게 토큰을 읽어오고 양 끝의 따옴표(")를 정제하는 헬퍼 함수
...
// --- 토큰 재발급 동안 동시 다발적 401 요청을 대기시킬 큐 선언 ---
...
axiosInstance.interceptors.response.use(
  ...
  async (error) => {
    ...
    if (
      ...
      // 2. 최초 401 에러 발생 시, 재시도 플래그와 refresh 진행 상태를 활성화합니다.
      originalRequest._retry = true;
      isRefreshing = true;
