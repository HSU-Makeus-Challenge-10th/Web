        ...
        <nav className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-md shadow-sm fixed w-full z-40 transition-colors duration-300">
            <div className="flex items-center justify-between p-4 max-w-7xl mx-auto">
                <div className="flex items-center space-x-4">
                    ...
                    <Link
                        to="/"
                        className="text-xl font-black text-purple-600 dark:text-purple-400 tracking-tighter hover:opacity-80 transition-opacity"
                    >
                        돌려돌려 LP판
                    </Link>
                </div>
                    ...
                    <div className="flex items-center space-x-1 md:space-x-2">
                        ...
                        {!accessToken ? (
                            <>
                                ...
                                <Link
                                    to="/signup"
                                    className="px-4 py-2 text-sm font-medium bg-purple-600 hover:bg-purple-700 text-white rounded-lg transition-all shadow-md hover:shadow-lg"
                                >
                                    회원가입
                                </Link>
                            </>
