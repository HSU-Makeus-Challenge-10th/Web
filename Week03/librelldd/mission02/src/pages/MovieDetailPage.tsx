...
const MovieDetailPage = () => {
    ...
    if (!movieDetail) return (
        <div className="min-h-screen bg-[#030005] flex items-center justify-center">
            <div className="animate-pulse text-purple-400 text-2xl font-light tracking-[0.2em]">LOADING...</div>
        </div>
    );

    return (
        <div className="min-h-screen bg-[#030005] text-purple-100 font-sans selection:bg-purple-500/30 overflow-x-hidden relative">
            ...
            <div className="relative z-10">
                ...
                <div className="h-[80vh] w-full flex items-center">
                    <div className="max-w-6xl mx-auto px-8 w-full flex items-center gap-16">
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <p className="text-purple-60 text-base leading-[2] max-w-2xl font-light line-clamp-5">
                ...
                <div className="max-w-6xl mx-auto  w-full">
                    <h2 className="text-3xl font-extralight tracking-[0.3em] uppercase mb-16 relative inline-block text-white">
                        Cast
                    ...
                    <div className="flex gap-12 overflow-x-auto pb-10 custom-scrollbar">
                        {credits?.cast?.slice(0, 15).map((person: any) => (
                            <div key={person.id} className="min-w-[160px] flex-shrink-0 group text-center">
                                ...
                                <p className="font-semibold text-purple-50 group-hover:text-purple-300 transition-colors duration-300">{person.name}</p>
                                <p className="text-sm text-purple-400/50 font-light mt-1 truncate px-2">{person.character}</p>
                            </div>
                        ))}
                    </div>
                </div>
