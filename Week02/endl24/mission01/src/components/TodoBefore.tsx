...
const TodoBefore = () => {
  ...
  return (
    <div className="todo-container">
      <h1 className="todo-container__header">Doo TODO</h1>
      ...
      <div className="render-container">
        <div className="render-container__section">
          ...
          <ul id="todo-list-active" className="render-container__list">
            {todos.map((todo) => (
        ...
        <div className="render-container__section">
          ...
          <ul id="todo-list-done" className="render-container__list">
            {doneTodos.map((todo) => (
              <li key={todo.id} className="render-container__item">
                <span className="render-container__item-text">{todo.text}</span>
                <button
