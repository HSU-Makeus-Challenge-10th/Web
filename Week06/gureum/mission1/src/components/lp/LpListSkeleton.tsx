// [Skeleton UI]
// 실제 LP 카드의 크기/배치를 미리 점유해 로딩 중 레이아웃 흔들림(CLS)을 줄인다.
// animate-pulse(Tailwind)로 깜빡이는 shimmer 애니메이션을 적용한다.
...
// 초기 로딩(isLoading)과 추가 페이지 로딩(isFetchingNextPage) 모두에서 재사용하는 그리드 스켈레톤
