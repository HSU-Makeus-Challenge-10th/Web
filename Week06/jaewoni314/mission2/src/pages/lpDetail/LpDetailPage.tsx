...
const LpDetailPage = () => {
  ...
  if (!lp) return <Error message="LP를 찾을 수 없습니다." />;
  ...
  return (
    <div className="min-h-full max-w-[60vw] mx-auto py-[3vh] px-[3vw]">
      ...
      {/* ✅ LP 정보 블록 */}
      <div className="bg-[#2c2c2c] rounded-lg p-[3vw] text-white mb-[3vh]">
        ...
        <div className="flex justify-center my-[5vh]">
          <div className="relative w-[25vw] h-[25vw]">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-[6vw] h-[6vw] min-w-20 min-h-20 bg-[#2c2c2c] shadow-xl rounded-full border-2 border-gray-600"></div>
            </div>
          </div>
        </div>
