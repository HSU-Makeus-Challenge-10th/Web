...
import { type AuthTokens, type User, AUTH_TOKENS_KEY, apiGetMe, apiSignout, getStoredAuthTokens } from '../api/client'
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    const checkAuth = async () => {
      if (!getStoredAuthTokens()?.accessToken) { setStatus('unauthenticated'); return }
      try {
